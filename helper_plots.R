...
print("Plotting SpES...")
plot_SpES(datN, "N", image_filename=paste(log_dir,"SpES_N_plot",file_suffix,".png",sep=""))
plot_SpES(datD, "D", image_filename=paste(log_dir,"SpES_D_plot",file_suffix,".png",sep=""))
plot_SpES(datQ, "Q", image_filename=paste(log_dir,"SpES_Q_plot",file_suffix,".png",sep=""))

print("Plotting MSE...")
plot_accuracy(datN, "N", image_filename=paste(log_dir,"MSE_N_plot",file_suffix,".png",sep=""))
plot_accuracy(datD, "D", image_filename=paste(log_dir,"MSE_D_plot",file_suffix,".png",sep=""))
plot_accuracy(datQ, "Q", image_filename=paste(log_dir,"MSE_Q_plot",file_suffix,".png",sep=""))
