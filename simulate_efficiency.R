...
if(model == 1) {
  ...
  save(fit.sc, file="fit_SC_N100_D30_Q100.RData")
}
...
if(model == 2) {
  ...
  save(fit.mongrel.eigen, file="fit_ME_N100_D30_Q100.RData")
}
...
if(model == 3) {
  ...
  save(fit.mongrel.cholesky, file="fit_MC_N100_D30_Q100.RData")
}
